...
const GetItemsData = () => {
        ...
        const itemsArray = itemsList.slice(0, 6);
        ...
        const viewItems = itemsArray.map((item) => {
                return (
        ...
        return (
                <>
                <div className="items-top center">
                        {viewItems}
                </div>
                <div className="browse-button center">
                        <Link to="/catalogpage"><button className="browse-button__text">Browse All Product</button></Link>
                </div>    
                </>
        )
